...
var G__50741 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__50742 = n;
var G__50743 = cljs.core.nnext(bs);
var G__50744 = true;
ret = G__50741;
n = G__50742;
bs = G__50743;
seen_rest_QMARK_ = G__50744;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50631_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__50631_SHARP_);
}
})(),cljs.core.name(p1__50631_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__50632_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = mkns;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(p1__50632_SHARP_);
}
})(),cljs.core.name(p1__50632_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__50633_SHARP_,p2__50634_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__50633_SHARP_,p2__50634_SHARP_,(function (){var fexpr__50705 = cljs.core.val(entry);
return (fexpr__50705.cljs$core$IFn$_invoke$arity$1 ? fexpr__50705.cljs$core$IFn$_invoke$arity$1(p2__50634_SHARP_) : fexpr__50705.call(null,p2__50634_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__50707 = cljs.core.key(entry);
return (fexpr__50707.cljs$core$IFn$_invoke$arity$1 ? fexpr__50707.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__50707.call(null,bes));
})());
...
var G__50775 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__50776 = cljs.core.next(bes);
ret = G__50775;
bes = G__50776;
continue;
} else {
...
var temp__5802__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50636_SHARP_){
return (cljs.core.first(p1__50636_SHARP_) instanceof cljs.core.Keyword);
}),bents));
