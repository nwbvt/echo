...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__45352(s__45353){
return (new cljs.core.LazySeq(null,(function (){
var s__45353__$1 = s__45353;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__45353__$1);
if(temp__5804__auto__){
var s__45353__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45353__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__45353__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__45355 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__45354 = (0);
while(true){
if((i__45354 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__45354);
...
cljs.core.chunk_append(b__45355,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__45480 = (i__45354 + (1));
i__45354 = G__45480;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45355),rewrite_clj$node$fn$fn_walk_$_iter__45352(cljs.core.chunk_rest(s__45353__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45355),null);
}
} else {
var i = cljs.core.first(s__45353__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__45352(cljs.core.rest(s__45353__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__45350_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__45350_SHARP_);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return p1__45350_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k45367,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__45379 = k45367;
var G__45379__$1 = (((G__45379 instanceof cljs.core.Keyword))?G__45379.fqn:null);
switch (G__45379__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45367,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__45382){
var vec__45386 = p__45382;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45386,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45386,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45366){
var self__ = this;
var G__45366__$1 = this;
return (new cljs.core.RecordIter((0),G__45366__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45368,other45369){
var self__ = this;
var this45368__$1 = this;
return (((!((other45369 == null)))) && ((((this45368__$1.constructor === other45369.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45368__$1.children,other45369.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45368__$1.__extmap,other45369.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k45367){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45367);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__45366){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__45456 = cljs.core.keyword_identical_QMARK_;
var expr__45457 = k__5352__auto__;
if(cljs.core.truth_((pred__45456.cljs$core$IFn$_invoke$arity$2 ? pred__45456.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__45457) : pred__45456.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__45457)))){
return (new rewrite_clj.node.fn.FnNode(G__45366,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__45366),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__45366){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__45366,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__45373){
var extmap__5385__auto__ = (function (){var G__45472 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__45373,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__45373)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45472);
} else {
return G__45472;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__45373),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
