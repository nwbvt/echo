...
var sq_dev_from_mean = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__49953_SHARP_){
return (p1__49953_SHARP_ * p1__49953_SHARP_);
}),dev_from_mean);
...
var indicies = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__49968,n){
var vec__49970 = p__49968;
var max_so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49970,(0),null);
var indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49970,(1),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49970,(2),null);
if((n == null)){
...
var vec__49985 = zprint.util.find_max(coll_vec);
var max_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(0),null);
var indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(1),null);
var length = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49985,(2),null);
...
var vec__49999 = cljs.core.split_at(index,columns);
var beginning = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49999,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49999,(1),null);
...
if((row_count > (2))){
var vec__50014 = zprint.util.remove_max_not_half(column);
var first_indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50014,(0),null);
var first_column_wo_max = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50014,(1),null);
...
var vec__50017 = zprint.util.remove_max_not_half(first_column_wo_max);
var second_indicies = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50017,(0),null);
var second_column_wo_max = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50017,(1),null);
...
var G__50240 = cljs.core.next(coll__$1);
var G__50241 = (index + (1));
var G__50242 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,(((index >= last_good_col))?null:zprint.util.size.cljs$core$IFn$_invoke$arity$2(cljs.core.first(coll__$1),no_string_adj_QMARK_)));
coll__$1 = G__50240;
index = G__50241;
out = G__50242;
continue;
...
var max_width_vec = cljs.core.second(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__50052,index){
var vec__50053 = p__50052;
var columns__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50053,(0),null);
var max_width_vec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50053,(1),null);
var vec__50056 = zprint.util.column_width_variance(max_variance,columns__$1,index);
var max_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50056,(0),null);
var new_columns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50056,(1),null);
...
return cljs.core.second(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__50073,column_max_width){
var vec__50074 = p__50073;
var current_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50074,(0),null);
var cumulative_widths = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50074,(1),null);
