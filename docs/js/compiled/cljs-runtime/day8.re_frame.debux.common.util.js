...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__74712){
var vec__74713 = p__74712;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74713,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74713,(1),null);
...
return clojure.zip.zipper((function (p1__74723_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__74723_SHARP_)) || (cljs.core.map_QMARK_(p1__74723_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__74728){
var vec__74729 = p__74728;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74729,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74729,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74739_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__74739_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__74738_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__74738_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74740_SHARP_){
return (((p1__74740_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__74740_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__74753,mapping){
var map__74754 = p__74753;
var map__74754__$1 = cljs.core.__destructure_map(map__74754);
var state = map__74754__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74754__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74754__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__74754__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__74752_SHARP_){
var and__5043__auto__ = (p1__74752_SHARP_ instanceof cljs.core.Symbol);
if(and__5043__auto__){
return cljs.core.namespace(p1__74752_SHARP_);
} else {
...
var G__74911 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__74913 = clojure.zip.next(loc);
loc = G__74913;
continue;
}
}
...
var len__5769__auto___74933 = arguments.length;
var i__5770__auto___74934 = (0);
while(true){
if((i__5770__auto___74934 < len__5769__auto___74933)){
args__5775__auto__.push((arguments[i__5770__auto___74934]));

var G__74935 = (i__5770__auto___74934 + (1));
i__5770__auto___74934 = G__74935;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__74810){
var vec__74811 = p__74810;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74811,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq74807){
var G__74808 = cljs.core.first(seq74807);
var seq74807__$1 = cljs.core.next(seq74807);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74808,seq74807__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__74815_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__74815_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__74829_74938 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__74830_74939 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__74831_74940 = true;
var _STAR_print_fn_STAR__temp_val__74832_74941 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__74831_74940);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__74832_74941);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__74830_74939);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__74829_74938);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5690__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__74827_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__74827_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__74942 = cljs.core.next(opts__$1);
var G__74943 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__74942;
acc = G__74943;
continue;
} else {
if(typeof f === 'string'){
var G__74945 = cljs.core.next(opts__$1);
var G__74946 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__74945;
acc = G__74946;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__74948 = cljs.core.nnext(opts__$1);
var G__74949 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__74948;
acc = G__74949;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__74950 = cljs.core.next(opts__$1);
var G__74951 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__74950;
acc = G__74951;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__74854 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__74854.cljs$core$IFn$_invoke$arity$1 ? fexpr__74854.cljs$core$IFn$_invoke$arity$1(f) : fexpr__74854.call(null,f));
})())){
var G__74953 = cljs.core.next(opts__$1);
var G__74954 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__74953;
acc = G__74954;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__74855 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__74855.cljs$core$IFn$_invoke$arity$1 ? fexpr__74855.cljs$core$IFn$_invoke$arity$1(f) : fexpr__74855.call(null,f));
})())){
var G__74955 = cljs.core.nnext(opts__$1);
var G__74956 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__74955;
acc = G__74956;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__74958 = cljs.core.next(opts__$1);
var G__74959 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__74958;
acc = G__74959;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__74857){
var vec__74858 = p__74857;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74858,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74858,(1),null);
...
var G__74871 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__74870 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__74870.cljs$core$IFn$_invoke$arity$1 ? fexpr__74870.cljs$core$IFn$_invoke$arity$1(G__74871) : fexpr__74870.call(null,G__74871));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__74875 = quoted_form;
var G__74876 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__74875,G__74876) : day8.re_frame.debux.common.util.remove_d.call(null,G__74875,G__74876));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__74878 = quoted_form;
var G__74879 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__74878,G__74879) : day8.re_frame.debux.common.util.remove_d.call(null,G__74878,G__74879));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__74967__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__74883 = quoted_form;
var G__74884 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__74883,G__74884) : day8.re_frame.debux.common.util.remove_d.call(null,G__74883,G__74884));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__74971__i = 0, G__74971__a = new Array(arguments.length -  0);
while (G__74971__i < G__74971__a.length) {G__74971__a[G__74971__i] = arguments[G__74971__i + 0]; ++G__74971__i;}
  arg = new cljs.core.IndexedSeq(G__74971__a,0,null);
} 
return G__74967__delegate.call(this,arg);};
G__74967.cljs$lang$maxFixedArity = 0;
G__74967.cljs$lang$applyTo = (function (arglist__74972){
var arg = cljs.core.seq(arglist__74972);
return G__74967__delegate(arg);
});
...
var G__74974 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__74974;
continue;
} else {
...
var G__74975 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__74975;
continue;
} else {
var G__74976 = clojure.zip.next(loc);
loc = G__74976;
continue;
