...
return rewrite_clj.node.protocols.coerce((function (){var G__47781 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
...
var len__5769__auto___47837 = arguments.length;
var i__5770__auto___47838 = (0);
while(true){
if((i__5770__auto___47838 < len__5769__auto___47837)){
args__5775__auto__.push((arguments[i__5770__auto___47838]));

var G__47839 = (i__5770__auto___47838 + (1));
i__5770__auto___47838 = G__47839;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__47782_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__47782_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq47783){
var G__47784 = cljs.core.first(seq47783);
var seq47783__$1 = cljs.core.next(seq47783);
var G__47785 = cljs.core.first(seq47783__$1);
var seq47783__$2 = cljs.core.next(seq47783__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47784,G__47785,seq47783__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__47814 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__47814) : str_fn.call(null,G__47814));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__47816 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__47816) : str_fn.call(null,G__47816));
})()):null)));
...
var G__47828 = rewrite_clj.zip.base.tag(zloc);
var G__47828__$1 = (((G__47828 instanceof cljs.core.Keyword))?G__47828.fqn:null);
switch (G__47828__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__47822_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__47822_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__47823_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__47823_SHARP_)].join('');
}));
}
}));
...
var G__47833 = rewrite_clj.zip.base.tag(zloc);
var G__47833__$1 = (((G__47833 instanceof cljs.core.Keyword))?G__47833.fqn:null);
switch (G__47833__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__47831_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__47831_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47833__$1)].join('')));
