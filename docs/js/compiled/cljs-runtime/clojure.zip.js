...
var G__45123 = clojure.zip.node(loc);
var fexpr__45122 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__45122.cljs$core$IFn$_invoke$arity$1 ? fexpr__45122.cljs$core$IFn$_invoke$arity$1(G__45123) : fexpr__45122.call(null,G__45123));
});
/**
...
var G__45126 = clojure.zip.node(loc);
var fexpr__45125 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var fexpr__45130 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__45130.cljs$core$IFn$_invoke$arity$2 ? fexpr__45130.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__45130.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__45131 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45131,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45131,(1),null);
var vec__45134 = clojure.zip.children(loc);
...
var vec__45139 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45139,(0),null);
var map__45142 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45139,(1),null);
var map__45142__$1 = cljs.core.__destructure_map(map__45142);
var path = map__45142__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45142__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45142__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45142__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45142__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45142__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__45143 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45143,(0),null);
var map__45146 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45143,(1),null);
var map__45146__$1 = cljs.core.__destructure_map(map__45146);
var path = map__45146__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45146__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__45150 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45146__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var map__45162 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45159,(1),null);
var map__45162__$1 = cljs.core.__destructure_map(map__45162);
var path = map__45162__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45162__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45162__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__45166 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45166,(0),null);
var map__45169 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45166,(1),null);
var map__45169__$1 = cljs.core.__destructure_map(map__45169);
var path = map__45169__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45169__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45169__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__45170 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45170,(0),null);
var map__45173 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45170,(1),null);
var map__45173__$1 = cljs.core.__destructure_map(map__45173);
var path = map__45173__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45173__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45173__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__45176 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45176,(0),null);
var map__45179 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45176,(1),null);
var map__45179__$1 = cljs.core.__destructure_map(map__45179);
var path = map__45179__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45179__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__45180 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45180,(0),null);
var map__45183 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45180,(1),null);
var map__45183__$1 = cljs.core.__destructure_map(map__45183);
var path = map__45183__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45183__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__45184 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45184,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45184,(1),null);
...
var len__5769__auto___45226 = arguments.length;
var i__5770__auto___45227 = (0);
while(true){
if((i__5770__auto___45227 < len__5769__auto___45226)){
args__5775__auto__.push((arguments[i__5770__auto___45227]));

var G__45228 = (i__5770__auto___45227 + (1));
i__5770__auto___45227 = G__45228;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq45187){
var G__45188 = cljs.core.first(seq45187);
var seq45187__$1 = cljs.core.next(seq45187);
var G__45189 = cljs.core.first(seq45187__$1);
var seq45187__$2 = cljs.core.next(seq45187__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45188,G__45189,seq45187__$2);
}));
...
var G__45238 = clojure.zip.rightmost(child);
loc__$1 = G__45238;
continue;
} else {
return loc__$1;
...
var vec__45208 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45208,(0),null);
var map__45211 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45208,(1),null);
var map__45211__$1 = cljs.core.__destructure_map(map__45211);
var path = map__45211__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45211__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45211__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45211__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45211__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__45239 = clojure.zip.rightmost(child);
loc__$1 = G__45239;
continue;
} else {
return loc__$1;
