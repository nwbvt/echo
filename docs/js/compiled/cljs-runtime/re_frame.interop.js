...
return [(function (){var pred__41020 = cljs.core.instance_QMARK_;
var expr__41021 = reactive_val;
if(cljs.core.truth_((pred__41020.cljs$core$IFn$_invoke$arity$2 ? pred__41020.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__41021) : pred__41020.call(null,reagent.ratom.RAtom,expr__41021)))){
return "ra";
} else {
if(cljs.core.truth_((pred__41020.cljs$core$IFn$_invoke$arity$2 ? pred__41020.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__41021) : pred__41020.call(null,reagent.ratom.RCursor,expr__41021)))){
return "rc";
} else {
if(cljs.core.truth_((pred__41020.cljs$core$IFn$_invoke$arity$2 ? pred__41020.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__41021) : pred__41020.call(null,reagent.ratom.Reaction,expr__41021)))){
return "rx";
} else {
if(cljs.core.truth_((pred__41020.cljs$core$IFn$_invoke$arity$2 ? pred__41020.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__41021) : pred__41020.call(null,reagent.ratom.Track,expr__41021)))){
return "tr";
} else {
return "other";
}
