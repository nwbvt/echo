...
return [(function (){var pred__26031 = cljs.core.instance_QMARK_;
var expr__26032 = reactive_val;
if(cljs.core.truth_((pred__26031.cljs$core$IFn$_invoke$arity$2 ? pred__26031.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__26032) : pred__26031.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__26032)))){
return "ra";
} else {
if(cljs.core.truth_((pred__26031.cljs$core$IFn$_invoke$arity$2 ? pred__26031.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__26032) : pred__26031.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__26032)))){
return "rc";
} else {
if(cljs.core.truth_((pred__26031.cljs$core$IFn$_invoke$arity$2 ? pred__26031.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__26032) : pred__26031.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__26032)))){
return "rx";
} else {
if(cljs.core.truth_((pred__26031.cljs$core$IFn$_invoke$arity$2 ? pred__26031.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__26032) : pred__26031.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__26032)))){
return "tr";
} else {
return "other";
}
