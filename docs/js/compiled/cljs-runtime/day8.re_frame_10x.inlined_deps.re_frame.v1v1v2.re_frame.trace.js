...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__27596){
var map__27597 = p__27596;
var map__27597__$1 = cljs.core.__destructure_map(map__27597);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27597__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27597__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27597__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27597__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__27601_27652 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__27602_27653 = null;
var count__27603_27654 = (0);
var i__27604_27655 = (0);
while(true){
if((i__27604_27655 < count__27603_27654)){
var vec__27625_27656 = chunk__27602_27653.cljs$core$IIndexed$_nth$arity$2(null,i__27604_27655);
var k_27657 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27625_27656,(0),null);
var cb_27658 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27625_27656,(1),null);
try{var G__27629_27663 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_27658.cljs$core$IFn$_invoke$arity$1 ? cb_27658.cljs$core$IFn$_invoke$arity$1(G__27629_27663) : cb_27658.call(null,G__27629_27663));
}catch (e27628){var e_27665 = e27628;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_27657,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_27665], 0));
}

var G__27671 = seq__27601_27652;
var G__27672 = chunk__27602_27653;
var G__27673 = count__27603_27654;
var G__27674 = (i__27604_27655 + (1));
seq__27601_27652 = G__27671;
chunk__27602_27653 = G__27672;
count__27603_27654 = G__27673;
i__27604_27655 = G__27674;
continue;
} else {
var temp__5804__auto___27676 = cljs.core.seq(seq__27601_27652);
if(temp__5804__auto___27676){
var seq__27601_27682__$1 = temp__5804__auto___27676;
if(cljs.core.chunked_seq_QMARK_(seq__27601_27682__$1)){
var c__5568__auto___27683 = cljs.core.chunk_first(seq__27601_27682__$1);
var G__27685 = cljs.core.chunk_rest(seq__27601_27682__$1);
var G__27686 = c__5568__auto___27683;
var G__27687 = cljs.core.count(c__5568__auto___27683);
var G__27688 = (0);
seq__27601_27652 = G__27685;
chunk__27602_27653 = G__27686;
count__27603_27654 = G__27687;
i__27604_27655 = G__27688;
continue;
} else {
var vec__27633_27691 = cljs.core.first(seq__27601_27682__$1);
var k_27692 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27633_27691,(0),null);
var cb_27693 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27633_27691,(1),null);
try{var G__27639_27699 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_27693.cljs$core$IFn$_invoke$arity$1 ? cb_27693.cljs$core$IFn$_invoke$arity$1(G__27639_27699) : cb_27693.call(null,G__27639_27699));
}catch (e27636){var e_27700 = e27636;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_27692,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_27700], 0));
}

var G__27701 = cljs.core.next(seq__27601_27682__$1);
var G__27702 = null;
var G__27703 = (0);
var G__27704 = (0);
seq__27601_27652 = G__27701;
chunk__27602_27653 = G__27702;
count__27603_27654 = G__27703;
i__27604_27655 = G__27704;
continue;
}
} else {
}
