...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__46446 = cljs.core.get_global_hierarchy;
return (fexpr__46446.cljs$core$IFn$_invoke$arity$0 ? fexpr__46446.cljs$core$IFn$_invoke$arity$0() : fexpr__46446.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__46448_SHARP_){
var _STAR_delimiter_STAR__orig_val__46453 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__46454 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__46454);

try{return rewrite_clj.parser.core.parse_next(p1__46448_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__46453);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___46477 = arguments.length;
var i__5770__auto___46478 = (0);
while(true){
if((i__5770__auto___46478 < len__5769__auto___46477)){
args__5775__auto__.push((arguments[i__5770__auto___46478]));

var G__46479 = (i__5770__auto___46478 + (1));
i__5770__auto___46478 = G__46479;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__46459){
var vec__46460 = p__46459;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46460,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq46455){
...
var G__46458 = cljs.core.first(seq46455__$2);
var seq46455__$3 = cljs.core.next(seq46455__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46456,G__46457,G__46458,seq46455__$3);
}));
...
var G__46466 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__46466)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__46466)){
...
return cljs.core.cons((function (){var G__46469 = rewrite_clj.reader.peek(reader);
switch (G__46469) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__46466)){
