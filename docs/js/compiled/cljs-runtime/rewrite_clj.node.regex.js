...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k45535,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45535,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__45562){
var vec__45563 = p__45562;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45563,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45563,(1),null);
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45534){
var self__ = this;
var G__45534__$1 = this;
return (new cljs.core.RecordIter((0),G__45534__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45536,other45537){
var self__ = this;
var this45536__$1 = this;
return (((!((other45537 == null)))) && ((((this45536__$1.constructor === other45537.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45536__$1.pattern,other45537.pattern)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45536__$1.__extmap,other45537.__extmap)))))));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k45535){
var self__ = this;
var this__5350__auto____$1 = this;
var G__45587 = k45535;
var G__45587__$1 = (((G__45587 instanceof cljs.core.Keyword))?G__45587.fqn:null);
switch (G__45587__$1) {
case "pattern":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45535);

}
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__45534){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__45592 = cljs.core.keyword_identical_QMARK_;
var expr__45593 = k__5352__auto__;
if(cljs.core.truth_((pred__45592.cljs$core$IFn$_invoke$arity$2 ? pred__45592.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__45593) : pred__45592.call(null,new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__45593)))){
return (new rewrite_clj.node.regex.RegexNode(G__45534,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__45534),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__45534){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__45534,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__45538){
var extmap__5385__auto__ = (function (){var G__45610 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__45538,new cljs.core.Keyword(null,"pattern","pattern",242135423));
if(cljs.core.record_QMARK_(G__45538)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45610);
} else {
return G__45610;
}
})();
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__45538),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
