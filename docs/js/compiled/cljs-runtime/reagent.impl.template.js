...
var G__40881 = o;
reagent.impl.template.goog$module$goog$object.set(G__40881,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__40910__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__40910 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__40911__i = 0, G__40911__a = new Array(arguments.length -  0);
while (G__40911__i < G__40911__a.length) {G__40911__a[G__40911__i] = arguments[G__40911__i + 0]; ++G__40911__i;}
  args = new cljs.core.IndexedSeq(G__40911__a,0,null);
} 
return G__40910__delegate.call(this,args);};
G__40910.cljs$lang$maxFixedArity = 0;
G__40910.cljs$lang$applyTo = (function (arglist__40912){
var args = cljs.core.seq(arglist__40912);
return G__40910__delegate(args);
});
G__40910.cljs$core$IFn$_invoke$arity$variadic = G__40910__delegate;
return G__40910;
})()
;
} else {
...
var G__40882 = o;
reagent.impl.template.goog$module$goog$object.set(G__40882,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__40913__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__40913 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__40914__i = 0, G__40914__a = new Array(arguments.length -  0);
while (G__40914__i < G__40914__a.length) {G__40914__a[G__40914__i] = arguments[G__40914__i + 0]; ++G__40914__i;}
  args = new cljs.core.IndexedSeq(G__40914__a,0,null);
} 
return G__40913__delegate.call(this,args);};
G__40913.cljs$lang$maxFixedArity = 0;
G__40913.cljs$lang$applyTo = (function (arglist__40915){
var args = cljs.core.seq(arglist__40915);
return G__40913__delegate(args);
});
...
var G__40883 = props;
var G__40883__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40883,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40883);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40883__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__40884 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40884,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__40884;
}
})(),id_class);
...
var G__40885 = (cljs.core.count(argv) - first_child);
switch (G__40885) {
case (0):
...
var vec__40886 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40886,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40886,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40886,(2),null);
...
var temp__5808__auto___40923 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___40923 == null)){
} else {
var key_40924 = temp__5808__auto___40923;
(jsprops.key = key_40924);
}
...
var temp__5808__auto___40925 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___40925 == null)){
} else {
var key_40926 = temp__5808__auto___40925;
(jsprops.key = key_40926);
}
...
var temp__5808__auto___40927 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___40927 == null)){
} else {
var key_40928 = temp__5808__auto___40927;
(jsprops.key = key_40928);
}
...
var temp__5808__auto___40929 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___40929 == null)){
} else {
var key_40930 = temp__5808__auto___40929;
(jsprops.key = key_40930);
}
...
var temp__5808__auto___40931 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___40931 == null)){
} else {
var key_40932 = temp__5808__auto___40931;
(jsprops.key = key_40932);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40896_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__40896_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__40898 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40898,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40898,(1),null);
...
break;
default:
var G__40934 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__40935 = compiler;
v = G__40934;
compiler = G__40935;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template40907 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template40907 = (function (opts,id,fn_to_element,parse_fn,meta40908){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta40908 = meta40908;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template40907.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40909,meta40908__$1){
var self__ = this;
var _40909__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template40907(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta40908__$1));
}));

(reagent.impl.template.t_reagent$impl$template40907.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40909){
var self__ = this;
var _40909__$1 = this;
return self__.meta40908;
}));

(reagent.impl.template.t_reagent$impl$template40907.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template40907.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template40907.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template40907.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template40907.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template40907.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta40908","meta40908",107164869,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template40907.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template40907.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template40907");

(reagent.impl.template.t_reagent$impl$template40907.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template40907");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template40907.
 */
reagent.impl.template.__GT_t_reagent$impl$template40907 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template40907(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta40908){
return (new reagent.impl.template.t_reagent$impl$template40907(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta40908));
});

}

return (new reagent.impl.template.t_reagent$impl$template40907(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
