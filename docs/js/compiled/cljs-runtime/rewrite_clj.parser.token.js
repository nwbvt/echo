...
var len__5769__auto___46275 = arguments.length;
var i__5770__auto___46276 = (0);
while(true){
if((i__5770__auto___46276 < len__5769__auto___46275)){
args__5775__auto__.push((arguments[i__5770__auto___46276]));

var G__46277 = (i__5770__auto___46276 + (1));
i__5770__auto___46276 = G__46277;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__46269){
var vec__46270 = p__46269;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46270,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__46261_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__46261_SHARP_) : allowed_QMARK_.call(null,p1__46261_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__46261_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq46262){
var G__46263 = cljs.core.first(seq46262);
var seq46262__$1 = cljs.core.next(seq46262);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46263,seq46262__$1);
}));
