...
var G__47872 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__47872__$1 = (((G__47872 == null))?null:cljs.core.iterate((function (loc){
...
var G__47872__$2 = (((G__47872__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__47872__$1));
var G__47872__$3 = (((G__47872__$2 == null))?null:cljs.core.last(G__47872__$2));
if((G__47872__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__47872__$3);
}
} else {
return zloc;
}
...
var G__47893 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__47894 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__47893;
parent = G__47894;
continue;
} else {
var G__47895 = rewrite_clj.zip.move.right(zloc_map_value);
var G__47896 = parent;
loc = G__47895;
parent = G__47896;
continue;
...
var G__47898 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__47899 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__47898;
parent = G__47899;
continue;
} else {
var G__47900 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__47901 = parent;
loc = G__47900;
parent = G__47901;
continue;
...
var G__47885 = zloc;
var G__47885__$1 = (((G__47885 == null))?null:rewrite_clj.zip.move.down(G__47885));
var G__47885__$2 = (((G__47885__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__47885__$1,k));
if((G__47885__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__47885__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__47886 = zloc;
var G__47886__$1 = (((G__47886 == null))?null:rewrite_clj.zip.move.down(G__47886));
var G__47886__$2 = (((G__47886__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__47886__$1));
var G__47886__$3 = (((G__47886__$2 == null))?null:rewrite_clj.zip.move.down(G__47886__$2));
var G__47886__$4 = (((G__47886__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__47886__$3,k));
if((G__47886__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__47886__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__47889 = rewrite_clj.zip.move.down(zloc);
var G__47889__$1 = (((G__47889 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__47889));
if((G__47889__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__47889__$1);
}
})(),k);
