...
var o16869 = temp__5802__auto__;
var temp__5802__auto____$1 = (o16869["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o16870 = temp__5802__auto____$1;
return (o16870["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15591__auto__ = f;
return (o__15591__auto__["toString"]).call(o__15591__auto__);
} else {
return "";
}
}catch (e16889){var _ = e16889;
return "";
}});
...
try{var o__15591__auto___17770 = t;
(o__15591__auto___17770["cljs$lang$ctorPrWriter"]).call(o__15591__auto___17770,t,writer);
}catch (e16991){var __17772 = e16991;
}
...
var char_code = (function (){var o__15591__auto__ = (new String(char$));
return (o__15591__auto__["charCodeAt"]).call(o__15591__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15591__auto__ = String;
return (o__15591__auto__["fromCharCode"]).call(o__15591__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__17004 = num_code;
switch (G__17004) {
case (1):
return (185);
...
var o__15591__auto__ = String;
return (o__15591__auto__["fromCharCode"]).call(o__15591__auto__,superscript_code);
});
/**
...
}catch (e17037){var _e__15600__auto__ = e17037;
return false;
}})())){
...
var vec__17039 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17039,(0),null);
...
var len__5769__auto___17806 = arguments.length;
var i__5770__auto___17807 = (0);
while(true){
if((i__5770__auto___17807 < len__5769__auto___17806)){
args__5775__auto__.push((arguments[i__5770__auto___17807]));

var G__17809 = (i__5770__auto___17807 + (1));
i__5770__auto___17807 = G__17809;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__17106){
var vec__17108 = p__17106;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17108,(0),null);
...
var G__17817 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__17818 = cljs.core.butlast(remaining_tokens);
name_tokens = G__17817;
remaining_tokens = G__17818;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq17102){
var G__17103 = cljs.core.first(seq17102);
var seq17102__$1 = cljs.core.next(seq17102);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17103,seq17102__$1);
}));
...
var vec__17119 = cljs.core.split_with((function (p1__17117_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__17117_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17119,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17119,(1),null);
...
var vec__17207 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17207,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17207,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__17825 = cljs.core.rest(remaining_tokens);
var G__17826 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__17825;
name_tokens = G__17826;
continue;
} else {
...
var vec__17226 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17226,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17226,(1),null);
var vec__17229 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17229,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17229,(1),null);
var vec__17232 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17232,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17232,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17232,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17232,(3),null);
...
var vec__17280 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17280,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17280,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17280,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17280,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17280,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17280,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__17303 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17303,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17303,(1),null);
var vec__17309 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17309,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17309,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__17324 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__17324) : devtools.munging.parse_fn_info_deep.call(null,G__17324));
})()));
}
} else {
return fn_info;
...
var G__17863 = (arity + (1));
var G__17864 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__17394){
var vec__17395 = p__17394;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17395,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17395,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17452_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__17452_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17454_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__17454_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__17482){
var vec__17484 = p__17482;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17484,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq17468){
var G__17469 = cljs.core.first(seq17468);
var seq17468__$1 = cljs.core.next(seq17468);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17469,seq17468__$1);
}));
...
var map__17534 = options;
var map__17534__$1 = cljs.core.__destructure_map(map__17534);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17534__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17534__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17534__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17534__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__17535 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17535,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17535,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17535,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17535,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17535,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17535,(5),null);
...
var o__15591__auto__ = f;
return (o__15591__auto__["getBasis"]).call(o__15591__auto__);
});
/**
...
}catch (e17563){var _e__15600__auto__ = e17563;
...
var G__17897 = (obj[cljs.core.first(path)]);
var G__17898 = cljs.core.rest(path);
obj = G__17897;
path = G__17898;
continue;
} else {
...
var _STAR_ = (function (accum,p__17645){
var vec__17649 = p__17645;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17649,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17649,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__17680){
var vec__17684 = p__17680;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17684,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17684,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17684,(2),null);
...
var post_process = (function (p__17735){
var vec__17736 = p__17735;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17736,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17736,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17708_SHARP_){
return (obj[cljs.core.first(p1__17708_SHARP_)]);
}),sorted_matches);
