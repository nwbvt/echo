...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k45328,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45328,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__45348){
var vec__45389 = p__45348;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45389,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45389,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45327){
var self__ = this;
var G__45327__$1 = this;
return (new cljs.core.RecordIter((0),G__45327__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45329,other45330){
var self__ = this;
var this45329__$1 = this;
return (((!((other45330 == null)))) && ((((this45329__$1.constructor === other45330.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45329__$1.prefix,other45330.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45329__$1.s,other45330.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45329__$1.__extmap,other45330.__extmap)))))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k45328){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45328);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__45327){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__45401 = cljs.core.keyword_identical_QMARK_;
var expr__45402 = k__5352__auto__;
if(cljs.core.truth_((pred__45401.cljs$core$IFn$_invoke$arity$2 ? pred__45401.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__45402) : pred__45401.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__45402)))){
return (new rewrite_clj.node.comment.CommentNode(G__45327,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45401.cljs$core$IFn$_invoke$arity$2 ? pred__45401.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__45402) : pred__45401.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__45402)))){
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,G__45327,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__45327),null));
}
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__45327){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,G__45327,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__45333){
var extmap__5385__auto__ = (function (){var G__45418 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45333,new cljs.core.Keyword(null,"prefix","prefix",-265908465),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"s","s",1705939918)], 0));
if(cljs.core.record_QMARK_(G__45333)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__45418);
} else {
return G__45418;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__45333),new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__45333),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
