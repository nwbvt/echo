...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__47903_SHARP_){
var G__47905 = rewrite_clj.custom_zipper.core.node(p1__47903_SHARP_);
if((!((G__47905 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__47905.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__47905.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__47905);
} else {
return false;
}
}
