...
var G__18011 = devtools.prefs.pref(v);
v = G__18011;
continue;
} else {
return v;
...
}catch (e17865){var _e__15600__auto__ = e17865;
return false;
}})();
...
}catch (e17868){var _e__15600__auto__ = e17868;
return false;
}})();
...
}catch (e17875){var _e__15600__auto__ = e17875;
return false;
}}
}
});
...
var vec__17966 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17966,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17966,(1),null);
...
return cljs.core.some((function (p1__17973_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17973_SHARP_);
}),template);
});
