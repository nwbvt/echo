...
var len__5769__auto___47864 = arguments.length;
var i__5770__auto___47865 = (0);
while(true){
if((i__5770__auto___47865 < len__5769__auto___47864)){
args__5775__auto__.push((arguments[i__5770__auto___47865]));

var G__47866 = (i__5770__auto___47865 + (1));
i__5770__auto___47865 = G__47866;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__47777){
var vec__47778 = p__47777;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47778,(0),null);
...
return (function (p1__47770_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__47770_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq47771){
var G__47772 = cljs.core.first(seq47771);
var seq47771__$1 = cljs.core.next(seq47771);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47772,seq47771__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__47789 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47789,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47789,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__47793 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__47796 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47793,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47796,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47796,(1),null);
var vec__47799 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47793,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47799,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47799,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47807_SHARP_){
var and__5043__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__47807_SHARP_) : p_QMARK_.call(null,p1__47807_SHARP_));
if(cljs.core.truth_(and__5043__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__47807_SHARP_,pos);
} else {
return and__5043__auto__;
}
...
var G__47832 = zloc;
var G__47832__$1 = (((G__47832 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__47832) : f.call(null,G__47832)));
if((G__47832__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__47832__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__47834_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__47834_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__47844_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__47844_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__47854_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__47854_SHARP_),v);
}));
