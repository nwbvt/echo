...
var G__50344 = rewrite_clj.zip.next(n);
loc = G__50344;
continue;
} else {
var G__50345 = rewrite_clj.zip.next(loc);
loc = G__50345;
continue;
}
} else {
var G__50346 = rewrite_clj.zip.next(loc);
loc = G__50346;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__50296 = zloc;
var G__50296__$1 = (((G__50296 == null))?null:rewrite_clj.zip.node(G__50296));
if((G__50296__$1 == null)){
return null;
} else {
return rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__50296__$1);
}
})())));
});
/**
...
var G__50356 = rewrite_clj.zip.down(nloc);
nloc = G__50356;
continue;
}
break;
...
var G__50366 = rewrite_clj.zip.right(nloc);
var G__50367 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__50366;
out = G__50367;
continue;
} else {
...
var G__50382 = rewrite_clj.zip.right(replaced_loc);
var G__50386 = cljs.core.next(new_loc);
var G__50387 = replaced_loc;
nloc = G__50382;
new_loc = G__50386;
last_loc = G__50387;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__50331_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__50331_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__50331_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
