 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__38897,right){
var map__38898 = p__38897;
var map__38898__$1 = cljs.core.__destructure_map(map__38898);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38898__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38898__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__38903 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38903,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38903,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38903,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38911__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__38912 = u(y);
var map__38912__$1 = cljs.core.__destructure_map(map__38912);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38912__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__38947__delegate = function (x,y,more){
...
var G__38947 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__38949__i = 0, G__38949__a = new Array(arguments.length -  2);
while (G__38949__i < G__38949__a.length) {G__38949__a[G__38949__i] = arguments[G__38949__i + 2]; ++G__38949__i;}
  more = new cljs.core.IndexedSeq(G__38949__a,0,null);
} 
return G__38947__delegate.call(this,x,y,more);};
G__38947.cljs$lang$maxFixedArity = 2;
G__38947.cljs$lang$applyTo = (function (arglist__38950){
var x = cljs.core.first(arglist__38950);
arglist__38950 = cljs.core.next(arglist__38950);
var y = cljs.core.first(arglist__38950);
var more = cljs.core.rest(arglist__38950);
return G__38947__delegate(x,y,more);
});
...
var G__38955 = null;
if (arguments.length > 2) {
var G__38956__i = 0, G__38956__a = new Array(arguments.length -  2);
while (G__38956__i < G__38956__a.length) {G__38956__a[G__38956__i] = arguments[G__38956__i + 2]; ++G__38956__i;}
G__38955 = new cljs.core.IndexedSeq(G__38956__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__38955);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38916__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__38917 = u(y);
var map__38917__$1 = cljs.core.__destructure_map(map__38917);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38917__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__38957__delegate = function (x,y,more){
...
var G__38957 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__38958__i = 0, G__38958__a = new Array(arguments.length -  2);
while (G__38958__i < G__38958__a.length) {G__38958__a[G__38958__i] = arguments[G__38958__i + 2]; ++G__38958__i;}
  more = new cljs.core.IndexedSeq(G__38958__a,0,null);
} 
return G__38957__delegate.call(this,x,y,more);};
G__38957.cljs$lang$maxFixedArity = 2;
...
return G__38957__delegate(x,y,more);
});
...
var G__38960 = null;
if (arguments.length > 2) {
var G__38961__i = 0, G__38961__a = new Array(arguments.length -  2);
while (G__38961__i < G__38961__a.length) {G__38961__a[G__38961__i] = arguments[G__38961__i + 2]; ++G__38961__i;}
G__38960 = new cljs.core.IndexedSeq(G__38961__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__38960);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38918__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__38919 = u(y);
var map__38919__$1 = cljs.core.__destructure_map(map__38919);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38919__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__38964__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__38965__i = 0, G__38965__a = new Array(arguments.length -  2);
while (G__38965__i < G__38965__a.length) {G__38965__a[G__38965__i] = arguments[G__38965__i + 2]; ++G__38965__i;}
  more = new cljs.core.IndexedSeq(G__38965__a,0,null);
} 
return G__38964__delegate.call(this,x,y,more);};
G__38964.cljs$lang$maxFixedArity = 2;
G__38964.cljs$lang$applyTo = (function (arglist__38967){
...
var G__38969 = null;
if (arguments.length > 2) {
var G__38970__i = 0, G__38970__a = new Array(arguments.length -  2);
while (G__38970__i < G__38970__a.length) {G__38970__a[G__38970__i] = arguments[G__38970__i + 2]; ++G__38970__i;}
G__38969 = new cljs.core.IndexedSeq(G__38970__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__38969);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38921__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__38922 = u(y);
var map__38922__$1 = cljs.core.__destructure_map(map__38922);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38922__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
var more = null;
if (arguments.length > 2) {
var G__38975__i = 0, G__38975__a = new Array(arguments.length -  2);
while (G__38975__i < G__38975__a.length) {G__38975__a[G__38975__i] = arguments[G__38975__i + 2]; ++G__38975__i;}
  more = new cljs.core.IndexedSeq(G__38975__a,0,null);
} 
return G__38973__delegate.call(this,x,y,more);};
G__38973.cljs$lang$maxFixedArity = 2;
G__38973.cljs$lang$applyTo = (function (arglist__38976){
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__38977);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
