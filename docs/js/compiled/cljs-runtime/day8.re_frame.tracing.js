...
var G__74960 = clojure.zip.next(loc);
var G__74961 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(seen,node);
loc = G__74960;
seen = G__74961;
continue;
} else {
var G__74962 = clojure.zip.next(loc);
var G__74963 = seen;
loc = G__74962;
seen = G__74963;
continue;
...
var len__5769__auto___74964 = arguments.length;
var i__5770__auto___74965 = (0);
while(true){
if((i__5770__auto___74965 < len__5769__auto___74964)){
args__5775__auto__.push((arguments[i__5770__auto___74965]));

var G__74966 = (i__5770__auto___74965 + (1));
i__5770__auto___74965 = G__74966;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame.tracing.fn_body.cljs$lang$applyTo = (function (seq74931){
var G__74932 = cljs.core.first(seq74931);
var seq74931__$1 = cljs.core.next(seq74931);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__74932,seq74931__$1);
}));
