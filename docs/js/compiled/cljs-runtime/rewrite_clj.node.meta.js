...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k46291,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46291,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__46298){
var vec__46299 = p__46298;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46299,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46299,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46292,other46293){
var self__ = this;
var this46292__$1 = this;
return (((!((other46293 == null)))) && ((((this46292__$1.constructor === other46293.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46292__$1.tag,other46293.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46292__$1.prefix,other46293.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46292__$1.children,other46293.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46292__$1.__extmap,other46293.__extmap)))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var vec__46307 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
var mta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46307,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46307,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k46291){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k46291);

}
}));

(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__46290){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__46315 = cljs.core.keyword_identical_QMARK_;
var expr__46316 = k__5352__auto__;
if(cljs.core.truth_((pred__46315.cljs$core$IFn$_invoke$arity$2 ? pred__46315.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__46316) : pred__46315.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__46316)))){
return (new rewrite_clj.node.meta.MetaNode(G__46290,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46315.cljs$core$IFn$_invoke$arity$2 ? pred__46315.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__46316) : pred__46315.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__46316)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__46290,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46315.cljs$core$IFn$_invoke$arity$2 ? pred__46315.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__46316) : pred__46315.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__46316)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__46290,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__46290),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__46290){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__46290,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__46294){
var extmap__5385__auto__ = (function (){var G__46319 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46294,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__46294)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46319);
} else {
return G__46319;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__46294),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__46294),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__46294),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
