...
var or__5045__auto____$2 = ((((((cljs.core.contains_QMARK_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(namespaces,new cljs.core.Symbol(null,"clojure.core","clojure.core",-189332625,null)),sym)) && (cljs.core.not((function (){var G__57958 = the_current_ns;
var G__57958__$1 = (((G__57958 == null))?null:new cljs.core.Keyword(null,"refer","refer",-964295553).cljs$core$IFn$_invoke$arity$1(G__57958));
var G__57958__$2 = (((G__57958__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__57958__$1,new cljs.core.Symbol(null,"clojure.core","clojure.core",-189332625,null)));
var G__57958__$3 = (((G__57958__$2 == null))?null:new cljs.core.Keyword(null,"exclude","exclude",-1230250334).cljs$core$IFn$_invoke$arity$1(G__57958__$2));
if((G__57958__$3 == null)){
return null;
} else {
return cljs.core.contains_QMARK_(G__57958__$3,sym);
}
...
var parse_opts = (function (){var G__57983 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(sci.impl.parser.default_opts,new cljs.core.Keyword(null,"features","features",-1146962336),features,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983),auto_resolve,new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"resolve-symbol","resolve-symbol",-319166964),(function (p1__57971_SHARP_){
return sci.impl.parser.fully_qualify(ctx,p1__57971_SHARP_);
...
var or__5045__auto____$1 = (function (){var fexpr__57989 = cljs.core.deref(sci.impl.parser.data_readers);
return (fexpr__57989.cljs$core$IFn$_invoke$arity$1 ? fexpr__57989.cljs$core$IFn$_invoke$arity$1(t) : fexpr__57989.call(null,t));
})();
if(cljs.core.truth_(or__5045__auto____$1)){
return or__5045__auto____$1;
} else {
var or__5045__auto____$2 = (function (){var G__57990 = (function (){var G__57992 = ctx;
var G__57993 = cljs.core.PersistentArrayMap.EMPTY;
var G__57994 = t;
var fexpr__57991 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__57991.cljs$core$IFn$_invoke$arity$3 ? fexpr__57991.cljs$core$IFn$_invoke$arity$3(G__57992,G__57993,G__57994) : fexpr__57991.call(null,G__57992,G__57993,G__57994));
})();
var G__57990__$1 = (((G__57990 == null))?null:cljs.core.meta(G__57990));
if((G__57990__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("sci.impl.record","map-constructor","sci.impl.record/map-constructor",1072184780).cljs$core$IFn$_invoke$arity$1(G__57990__$1);
}
})();
if(cljs.core.truth_(or__5045__auto____$2)){
return or__5045__auto____$2;
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__57983,opts], 0));
} else {
return G__57983;
}
})();
...
}catch (e58000){if((e58000 instanceof cljs.core.ExceptionInfo)){
var e = e58000;
