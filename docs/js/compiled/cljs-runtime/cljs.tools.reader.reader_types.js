...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29785 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29785(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29787 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29787(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29788 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29788(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29789 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29789(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29796 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29796(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29797 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29797(reader);
}
});
...
var G__29831 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29832 = s.append(c);
c = G__29831;
s = G__29832;
continue;
}
