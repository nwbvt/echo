...
var rewrite_clj$node$protocols$Node$tag$dyn_45293 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_45293(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_45298 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_45298(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_45300 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_45300(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_45301 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_45301(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_45308 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_45308(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_45313 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_45313(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45217_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__45217_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_45331 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_45331(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_45334 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_45334(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_45336 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_45336(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_45341 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_45341(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_45349 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_45349(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_45351 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_45351(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_45356 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_45356(node);
}
});
...
var map__45282 = cljs.core.meta(node);
var map__45282__$1 = cljs.core.__destructure_map(map__45282);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45282__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45282__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45282__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45282__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__45283,p__45284){
var vec__45285 = p__45283;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45285,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45285,(1),null);
var vec__45288 = p__45284;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45288,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45288,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__45291 = col_extent;
if((row_extent === (0))){
return (G__45291 + col);
} else {
return G__45291;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__45292 = rewrite_clj.node.protocols.children(node);
var G__45292__$1 = (((G__45292 == null))?null:cljs.core.first(G__45292));
if((G__45292__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__45292__$1);
}
} else {
