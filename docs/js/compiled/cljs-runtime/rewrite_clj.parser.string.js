...
if((c === "\n")){
var G__46264 = escape_QMARK_;
var G__46265 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__46264;
lines = G__46265;
continue;
} else {
buf.append(c);

var G__46266 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__46267 = lines;
escape_QMARK_ = G__46266;
lines = G__46267;
continue;
