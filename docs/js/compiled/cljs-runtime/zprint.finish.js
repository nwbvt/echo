...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__45107_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__45107_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__45107_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__45108){
var vec__45109 = p__45108;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45109,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45109,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__45112,s,color,element,idx){
var map__45113 = p__45112;
var map__45113__$1 = cljs.core.__destructure_map(map__45113);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45113__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45113__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45113__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__45116 = (function (){var or__5045__auto__ = color;
...
var fexpr__45115 = (function (){var G__45117 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__45117) : style_map.call(null,G__45117));
})();
return (fexpr__45115.cljs$core$IFn$_invoke$arity$1 ? fexpr__45115.cljs$core$IFn$_invoke$arity$1(G__45116) : fexpr__45115.call(null,G__45116));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__45118){
var vec__45119 = p__45118;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45119,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45119,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45119,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__45124){
var vec__45127 = p__45124;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45127,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45127,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45127,(2),null);
...
var vec__45154 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45154,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45154,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45154,(2),null);
...
var G__45250 = cljs.core.next(remaining_cvec);
var G__45251 = new_idx;
var G__45252 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__45250;
idx = G__45251;
out = G__45252;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__45190,cursor_vec){
var vec__45191 = p__45190;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45191,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45191,(1),null);
var focus_vec = vec__45191;
...
var vec__45194 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45194,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45194,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__45197){
var vec__45198 = p__45197;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45198,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45198,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__45204,existing_count){
var vec__45205 = p__45204;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45205,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45205,(1),null);
...
return cljs.core.filterv((function (p1__45201_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__45201_SHARP_))));
...
var vec__45219 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45219,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45219,(1),null);
var cvec_element = vec__45219;
if((cvec_element == null)){
var G__45262 = cljs.core.next(cvec_nl);
var G__45263 = (idx + (1));
var G__45264 = start;
var G__45265 = out;
cvec_nl = G__45262;
...
var G__45266 = cljs.core.next(cvec_nl);
var G__45267 = (idx + (1));
var G__45268 = idx;
var G__45269 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__45266;
idx = G__45267;
start = G__45268;
out = G__45269;
...
var G__45270 = cljs.core.next(cvec_nl);
var G__45271 = (idx + (1));
var G__45272 = (idx + (1));
var G__45273 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__45270;
idx = G__45271;
start = G__45272;
out = G__45273;
...
var G__45274 = cljs.core.next(cvec_nl);
var G__45275 = (idx + (1));
var G__45276 = idx;
var G__45277 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__45274;
idx = G__45275;
start = G__45276;
out = G__45277;
...
var G__45278 = cljs.core.next(cvec_nl);
var G__45279 = (idx + (1));
var G__45280 = start;
var G__45281 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__45278;
idx = G__45279;
start = G__45280;
out = G__45281;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__45225_SHARP_,p2__45224_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__45224_SHARP_)){
return cljs.core.reduced(p1__45225_SHARP_);
} else {
return (p1__45225_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__45229,p__45230){
var vec__45232 = p__45229;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45232,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45232,(1),null);
var vec__45235 = p__45230;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45235,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45235,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__45241,cvec,focus_vec){
var map__45242 = p__45241;
var map__45242__$1 = cljs.core.__destructure_map(map__45242);
var options = map__45242__$1;
var map__45243 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45242__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__45243__$1 = cljs.core.__destructure_map(map__45243);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45243__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45243__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45243__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45240_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__45240_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
